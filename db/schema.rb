...
ActiveRecord::Schema[7.2].define(version: 2026_05_12_120002) do
  ...
  create_table "task_occurrences", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["status"], name: "index_task_occurrences_on_status"
  ...
  create_table "tasks", force: :cascade do |t|
    ...
    t.jsonb "recurrence_params", default: {}, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
